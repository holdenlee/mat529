...
By translating $f$, \wog we can assume that for all $x\in \cal N_\de$, $\ve{f(x)}_Y\le 2L$. 

\step{1} Rough (i.e., noncontinuous) extension $F_1$ on $S_X$. This is a partition of unity argument. %Consider the open cover 
